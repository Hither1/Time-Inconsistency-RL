...
# simple
MC = pd.read_csv("../results/simple/mc/round_1/V_values_0.4.csv")
fwd = pd.read_csv("../results/simple/fwd/round_5/V_values_0.4.csv")
bwd = pd.read_csv("../results/simple/BPI/round_6/V_values_0.4.csv")
...
plt.plot(x, bwd.iloc[:num_episode,1], linewidth=linewidth, color=color_2, label='bwdQ')# (\u03B5=.07,\u03B1' + r'$_{Q}$' + '=.4,'+ r"$\bar{T}=100$")
...
plt.plot(x, fwd.iloc[:num_episode,1], linewidth=linewidth, color=color_1, label='sophEU') # (\u03B5=.07,\u03B1' + r'$_{Q}$' + '=.4,'+ r"$\bar{T}=100$")
...
plt.xlabel('Episodes')
plt.ylabel('Value')
MC_stoc = pd.read_csv("../results/stoc/mc/round_6/V_values_0.4.csv")
fwd_stoc = pd.read_csv("../results/stoc/fwd/round_1/V_values_0.4.csv")
bwd_stoc = pd.read_csv("../results/stoc/BPI/round_2/V_values_0.4.csv")
#plt.set_axisbelow(True)
#plt.yaxis.grid(color='gray', linestyle='dashed')
 #
plt.plot(x, bwd_stoc.iloc[:num_episode, 1], color=color_2, linewidth=linewidth,
         label='bwdQ') # (\u03B5=.07,' + '\u03B1' + r'$_{Q}$' + '=.4,' + r"$\bar{T}=100$")
...
plt.plot(x, fwd_stoc.iloc[:num_episode, 1], color=color_1, linewidth=linewidth,
         label='sophEU') # (\u03B5=.07,' + '\u03B1' + r'$_{Q}$' + '=.4,' + r"$\bar{T}=100$")
